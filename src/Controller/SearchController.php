...
class SearchController extends Controller
{
    ...
    public function showAction(Request $request, $slug)
    {
        ...
        if ($slug) {
            /** @var \Tenolo\Bundle\FAQBundle\Entity\Search $search */
        ...
        elseif ($query != '') {
            ...
            /** @var \Tenolo\Bundle\FAQBundle\Entity\Question $question */
    ...
    /**
     * @return \Tenolo\Bundle\FAQBundle\Entity\QuestionRepository
     */
    ...
    /**
     * @return \Tenolo\Bundle\FAQBundle\Entity\SearchRepository
     */
